Attribute VB_Name = "LockVBAProject"
Option Explicit
' Source: https://www.mrexcel.com/board/threads/lock-unlock-vbaprojects-programmatically-without-sendkeys.1136415/
...
Public Property Let LockVBProject(ByVal WorkbookName As String, _
    ...
    With Application.VBE
        ...
        If bLock Then
            ...
            Else
                MsgBox "VBProject already locked": Exit Property
            End If
        Else
            If .ActiveVBProject.Protection Then
                sWinClassName = "VBAProject Password"
            Else
                MsgBox "VBProject already unlocked": Exit Property
            End If
        End If
    End With
